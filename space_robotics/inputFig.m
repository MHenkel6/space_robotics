...
%                 'Position',         [0, 1-self.boxHeight, 2*self.boxWidth+self.horMargin, self.boxHeight]);
            ...
            self.resetButton = uicontrol(...
                ...
                'Position',         [lastPos(1)+lastPos(3)+self.horMargin,...
                                     ...
                                     self.boxWidth,...
                                     self.boxHeight],...
                'Callback',         @(x,y) self.moveToNeutralState);
            ...
            %% Via Point selector
            self.viaPointSelect = uicontrol(...
                'Parent',           self.fig,...
                'Style',            'popupmenu',...
                'String',           {'Direct','Via-points'},...
                'Value',            1,...
                'Fontsize',         self.fontSize,...
                'TooltipString',    'Path planning options',...
                'Units',            'normalized',...
                'Position',         [lastPos(1)+lastPos(3)+self.horMargin,...
                                     1-2*self.boxHeight-self.verMargin,...
                                     3.5*self.boxWidth,...
            ...
            self.textBox = uicontrol(...
                    ...
                    'Units',            'normalized',...
                    'Position',         [lastPos(1)+lastPos(3)+self.horMargin,...
                                         1-6*self.boxHeight-3*self.verMargin,...
                                         3.5*self.boxWidth,...
                                         2.5*self.boxHeight]);
            ...
            self.ps3Button = uicontrol(...
                    ...
                    'Units',            'normalized',...
                    'Position',         [lastPos(1)+lastPos(3)+self.horMargin,...
                                         1-10*self.boxHeight-3*self.verMargin,...
                                         3.5*self.boxWidth,...
                                         self.boxHeight],...
    ...
    methods(Access=private)
        ...
        function routineMove(self, ~, ~)
            viapoint = (self.viaPointSelect.Value == 2);
            ...
            [Qplan,vq,aq,tarray] = path_planning(30,self.t_step/overSample, ...
                                        [self.robotKin.q; qMotion], ...
                                          [self.robotKin.qdotMax; 0.5*self.robotKin.qdotMax], viapoint);
            if isempty(Qplan)
